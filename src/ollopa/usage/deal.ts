...
export const dealItems: UsageItem[] = [
  // Header fields
  { id: "deal.stage", page: "deal", area: "Header fields", label: "Stage", weekly: { sdr: 30, ae: 95, cs: 60, admin: 40 }, overrides: { fathom: { admin: 80 }, halyard: { admin: 70 }, ridgeline: { cs: 80 } }, note: "Moving the stage is the job. The stepper is the page's spine." },
  { id: "deal.amount", page: "deal", area: "Header fields", label: "Amount", weekly: { sdr: 30, ae: 70, cs: 45, admin: 35 }, overrides: { fathom: { admin: 60 }, halyard: { admin: 30 } } },
  { id: "deal.close-date", page: "deal", area: "Header fields", label: "Close date", weekly: { sdr: 30, ae: 75, cs: 60, admin: 35 }, overrides: { fathom: { admin: 55 }, halyard: { admin: 25 }, ridgeline: { cs: 80 } }, note: "At Ridgeline the close date of a renewal is the renewal date CS lives by." },
  { id: "deal.next-step", page: "deal", area: "Header fields", label: "Next step and its date", weekly: { sdr: 30, ae: 85, cs: 55, admin: 30 }, overrides: { fathom: { admin: 70 }, halyard: { admin: 60 } } },
  { id: "deal.owner", page: "deal", area: "Header fields", label: "Owner", weekly: { sdr: 30, ae: 15, cs: 10, admin: 30 }, overrides: { fathom: { admin: 10 }, halyard: { admin: 45 } }, note: "Admins reassign; AEs rarely give a deal away. Halyard moves deals between specialists as client work shifts." },
  ...
  { id: "deal.last-activity", page: "deal", area: "Header fields", label: "Last activity", weekly: { sdr: 30, ae: 40, cs: 35, admin: 40 }, overrides: { halyard: { admin: 50 } }, note: "The staleness check: how long since anyone touched this deal." },
