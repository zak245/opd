...
// The Page type has no "shell" value, so these carry page: "home" and area: "shell". Baseline numbers describe Meridian.
...
export const shellItems: UsageItem[] = [
  ...
  // Sidebar, one item per page. A role that does not have a page in its sidebar carries no number (0).
  ...
  { id: "nav.inbox", page: "home", area: "shell", label: "Sidebar: Inbox", weekly: { sdr: 95, ae: 80 }, overrides: { ridgeline: { sdr: 50, ae: 40 } } },
  { id: "nav.tasks", page: "home", area: "shell", label: "Sidebar: Tasks", weekly: { sdr: 90, ae: 75, cs: 60 } },
  ...
  { id: "bell.approval", page: "home", area: "shell", label: "Notification: agent items waiting for approval", weekly: { sdr: 45, ae: 20, marketer: 15, admin: 40 }, overrides: { fathom: { sdr: 60, admin: 70 }, ridgeline: { sdr: 20, marketer: 30 } } },
