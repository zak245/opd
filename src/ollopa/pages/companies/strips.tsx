...
export function ConfirmStrip({ text, confirmLabel, onConfirm, onCancel, tone, children }: {
  ...
  return (
    <div
      ...
      className={cn("flex flex-wrap items-center gap-2 t-body", tone === "destructive" && "[color:var(--danger-ink)]")}
    >
...
export function Notice({ text, undo, onDone }: { text: string; undo?: () => void; onDone: () => void }) {
  ...
  return (
    <div role="status" aria-live="polite" className="flex flex-wrap items-center gap-2 t-body">
