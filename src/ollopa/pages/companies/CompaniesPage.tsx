...
export function CompaniesPage({ session }: { session: Session }) {
  ...
  const allColumns: Col<CompanyView>[] = [
    ...
    { id: "co.col.industry", header: "Industry", sortValue: (v) => v.company.industry, cell: (v) => v.company.industry },
    { id: "co.col.employees", header: "Employees", className: "tabular-nums", sortValue: (v) => v.company.employees, cell: (v) => v.company.employees.toLocaleString() },
    { id: "co.col.owner", header: "Owner", sortValue: (v) => v.company.owner, cell: (v) => v.company.owner },
    ...
    { id: "co.col.location", header: "Location", sortValue: (v) => v.company.location.country, cell: (v) => `${v.company.location.city}, ${v.company.location.country}` },
    ...
    { id: "co.col.revenue", header: "Revenue", sortValue: (v) => v.company.revenue, cell: (v) => v.company.revenue },
