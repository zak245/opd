// Containment: where the five roles actually appear.
//   node scripts/shot-containment.mjs shots/containment 1440 900
import puppeteer from "puppeteer-core"
import { mkdirSync } from "node:fs"
const [dir = "shots/containment", w = "1440", h = "900"] = process.argv.slice(2)
...
for (const theme of ["light", "dark"]) {
  ...
  await wait(800); await shot("4-people-pane")

  // People: the table in its container.
  await as("sdr", "/ollopa/people"); await shot("2-people")
