// The two surfaces the identity pass asks for, in both themes: a sequence record with the pane
// open, and the Sequences index.
//
//   node scripts/shot-identity.mjs shots/identity/engage
import puppeteer from "puppeteer-core"
import { mkdirSync } from "node:fs"
const [dir = "shots/identity/engage"] = process.argv.slice(2)
const base = process.env.OPD_BASE ?? "http://localhost:4190"
