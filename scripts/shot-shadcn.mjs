...
//
//   node scripts/shot-identity.mjs shots/shadcn/engage
import puppeteer from "puppeteer-core"
import { mkdirSync } from "node:fs"
const [dir = "shots/shadcn/engage"] = process.argv.slice(2)
const base = process.env.OPD_BASE ?? "http://localhost:4201"
